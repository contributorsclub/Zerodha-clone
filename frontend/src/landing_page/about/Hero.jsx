  ...
  return (
    <div className='container p-5'>
        <div className="row text-center mt-5 mb-5">
            <h1 className='mb-5 fw-semibold lh-base' style={{fontSize:'32px', color:'#424242'}}>We pioneered the discount broking model in India. <br />
            Now, we are breaking ground with our technology.</h1>
            <hr className='mt-5 mb-2'/>
        </div>
        <div className='row mx-5 p-5'>
            <div className="col lh-base " style={{fontWeight:'400', color:'#424242'}}>
